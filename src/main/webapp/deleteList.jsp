...
<html>
    ...
    "                </table></br>");
                        ...
                        "                    <tr>");
                                ...
                                out.println("<tr onmouseover=\"showImg(this)\" onmouseout=\"hideImg(this)\" data-file=\""+ rs.getString("filename") + "\" data-value=\""+ jlink.Const.AppConst.SAVE_DIR + File.separator + rs.getString("filename") + ".jpeg\" "
        ...
        <script type="text/javascript" src=<%= jlink.Const.AppConst.JS_TABLE_VIEW_PATH %>></script>
        <script type="text/javascript" src=<%= jlink.Const.AppConst.JS_DELETE_FILE_PATH %>></script>
    </body>
</html>
