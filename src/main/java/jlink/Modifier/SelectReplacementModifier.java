...
@WebServlet(name = "SelectReplacementModifier", urlPatterns = { "/SelectReplacementModifier" })
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
        maxFileSize = 1024 * 1024 * 10, // 10MB
        maxRequestSize = 1024 * 1024 * 50, // 50MB
        location = "/")
public class SelectReplacementModifier extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AppUtilsModifier.saveImage(appPath, filePart, link_image.getTitle() + "_original");
            AppUtilsModifier.saveImage(appPath, filePart, link_image.getTitle());
            ...
            try (PrintWriter out = response.getWriter()) {
                if(replacement.equals("roi")){
                    ...
                    out.println("<p>Image size:</p>    \n" +
                            ...
                            "                    </ul>");
                    out.println("<form id=\"addReplacement\" method=\"post\" action=\"SelectSpriteModifier\", enctype = \"multipart/form-data\">\n" +
                            ...
                            + File.separator + link_image.getTitle() + ".jpeg\">\n" +
                            "                        <div id=\"roi\"></div>\n"+
                            "                    </div>\n" +
                            "                    <div class=\"images\">\n " +
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("/SelectSpriteModifier");
